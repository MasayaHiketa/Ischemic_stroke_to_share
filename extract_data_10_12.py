...
merged_df = pd.read_csv("select.csv", dtype={'subject_id': int}, parse_dates=['time_minus_10h', 'time_minus_12h'])
...
hrv_path = 'extracted_data_10_12_for_you.csv'
...
for idx, row in merged_df.iterrows():
    ...
    t_start = row['time_minus_12h']
    t_end = row['time_minus_10h']
